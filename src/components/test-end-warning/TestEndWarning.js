            ...
            <div className="test-end-warning-2">
                <div className="test-end-warning-2-content">
                    <div className="header">
                        <div className="title">
                            <svg onClick={props.endtask} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="btn-container">
                        <button className="no" onClick={props.endtask}>
